...
${fullValues.LLAMA_CLOUD_API_KEY ? `LLAMA_CLOUD_API_KEY=${fullValues.LLAMA_CLOUD_API_KEY}` : 'LLAMA_CLOUD_API_KEY='}
...
LLAMA_CLOUD_API_KEY=${getEnvValue('LLAMA_CLOUD_API_KEY') || ''}
